...
/*
 * This is an alternate method (ide_helper copied from another application) to deriving each model
 * from BaseModel instead of Model.
 *
 * - The BaseModel method requires manually adding PHPDoc to BaseModel
 * - This method requires (a) manually copying ide_helper generated for an external Laravel app,
 *                        (b) adding the @mixin PHPDoc reference to each model (see Group)
 */
